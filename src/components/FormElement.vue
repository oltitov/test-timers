...
const isValidMinute = computed(() => Number.isInteger(minutes.value) && minutes.value % 1 === 0)
const isValidSeconds = computed(() => Number.isInteger(seconds.value) && seconds.value % 10 === 0)
